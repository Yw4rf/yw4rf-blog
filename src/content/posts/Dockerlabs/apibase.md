...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-1.png)
...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-4.png)
...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-5.png)
...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-6.png)

Una vez añadidos ambos parámetros al enviar la petición la respuesta nos indica el mensaje **`"User added"`** 

![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-7.png)
...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-8.png)
...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-9.png)
...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-10.png)

Se accedió correctamente mediante **SSH** con las credenciales **`pingu:pinguinasio`** encontradas anteriormente:  

![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-11.png)

## Privilege Escalation

Dentro del directorio **`/home`** se encontró un archivo **.PCAP** 

![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-12.png)
...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-13.png)
...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-14.png)
...
![Yw4rf ApiBase](../../../assets/DockerLabs/ApiBase/apibase-15.png)
